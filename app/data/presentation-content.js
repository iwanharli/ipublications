export const presentationContent = [
  ...
  {
    id: "slide-3",
    indicator: "SLIDE 3 — DOMAIN BARU",
    title: "Ruang Siber sebagai <br/> <span class=\"highlight\">Domain Baru Kamtibmas</span>",
    keypoints: [
      "Ruang siber bukan ruang tambahan, melainkan domain utama baru Kamtibmas.",
  ...
  {
    id: "slide-4",
    indicator: "SLIDE 4 — PARADIGMA BARU",
    title: "Paradigma Baru Polri: <br/> <span class=\"highlight\">Digital-First, Data-Driven, Cyber-Aware</span>",
    keypoints: [
      "Digital-First: Memahami dimensi digital dalam setiap fungsi kepolisian.",
      "Data-Driven: Pengambilan keputusan berbasis tren dan validitas data.",
  ...
  },
  {
    ...
    narrative: [
      ...
      "Karena itu, data harus dikelola seperti barang bukti strategis. Tidak semua orang boleh mengakses. Akses harus berdasarkan kebutuhan tugas. Setiap akses sebaiknya tercatat. Data sensitif harus diklasifikasikan dan dilindungi lebih kuat.",
      "Di sinilah UU Pelindungan Data Pribadi menjadi penting. Bukan semata sebagai kewajiban hukum, tetapi sebagai pengingat bahwa data masyarakat adalah amanah.”"
    ],
    analogy: {
      icon: "fa-solid fa-lightbulb",
      label: "ANALOGI PEMBICARA",
      text: "“Data sensitif itu seperti barang bukti di ruang penyimpanan. Tidak semua orang boleh masuk. Yang masuk harus jelas kewenangannya, tercatat, dan bisa diaudit.”"
    },
    interactive: {
      type: "alternate",
      label: "PERTANYAAN INTERAKTIF",
      questions: [
        "“Kalau data laporan masyarakat bocor, menurut Bapak/Ibu apa dampak paling berat: risiko hukum, risiko operasional, atau hilangnya kepercayaan publik?”"
      ],
      guidance: {
        label: "ARAHKAN:",
        text: ["“Ketiganya penting. Tetapi hilangnya kepercayaan publik sering kali paling sulit dipulihkan.”"]
      }
    },
    supplements: {
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Perintah prioritas: Aktifkan respons insiden, batasi dampak, dan amankan bukti digital."
    ],
    narrative: [
      "“Bapak/Ibu sekalian, kita mulai dengan simulasi ransomware.",
      "<strong>Pukul 09.00</strong>, sebuah email masuk ke salah satu staf. Isinya tampak biasa: pemberitahuan update sistem, undangan rapat, atau dokumen yang harus segera dibuka.",
      "<strong>Pukul 09.05</strong>, staf tersebut mengklik tautan atau membuka lampiran.",
  ...
  },
  {
    ...
    interactive: {
      ...
      label: "PERTANYAAN INTERAKTIF",
      questions: [
        "“Kapan terakhir backup di satuan kerja benar-benar diuji, bukan hanya diasumsikan ada?”"
      ],
      guidance: {
        label: "LANJUTKAN:",
        text: ["“Pertanyaan ini penting. Karena backup yang belum pernah diuji itu seperti senjata yang belum pernah dicek. Kita baru tahu macet atau tidak saat kondisi darurat. Dan itu sudah terlambat.”"]
      }
    },
    supplements: {
  ...
  },
  {
    ...
    interactive: {
      type: "provocative",
      label: "PERTANYAAN PROVOKATIF",
      questions: [
        "“Jika hari ini pengacara tersangka menggugat bahwa rekaman CCTV yang kita ajukan adalah hasil editan AI, apakah kita punya log, metadata, hash, dan chain of custody yang membuktikan sebaliknya?”"
      ]
    },
    supplements: {
  ...
  },
  {
    ...
    keypoints: [
      ...
      "Hashing: Membuat sidik jari digital untuk menjamin data tidak berubah.",
      "Dokumentasi Visual: Memperkuat integritas TKP digital dari tuduhan manipulasi."
    ],
    narrative: [
      "“Bapak/Ibu sekalian, dalam penanganan bukti digital, ada tiga tindakan awal yang perlu dipahami pimpinan.",
      "Pertama, <strong>isolasi sinyal</strong>. Perangkat digital bisa dihapus dari jarak jauh. Akun bisa logout. Data bisa berubah. Karena itu, perangkat yang disita harus diamankan agar tidak menerima perintah dari luar.",
      "Kedua, <strong>hashing</strong>. Hash adalah semacam sidik jari digital. Dengan hash, kita bisa membuktikan apakah file berubah atau tetap sama sejak diambil sampai dianalisis.",
      "Ketiga, <strong>dokumentasi visual</strong>. Proses penyitaan, kondisi perangkat, layar, kabel, lokasi, dan siapa yang menyaksikan perlu didokumentasikan. Ini penting untuk menghindari tuduhan bahwa bukti dimanipulasi atau ditanam.",
      "Tentu, detail teknis dilakukan oleh petugas yang berkompeten. Tetapi pimpinan harus memastikan SOP tersedia, personel memahami, alat pendukung ada, dan prosedur dijalankan.",
      "Dalam dunia digital, prosedur bukan formalitas. Prosedur adalah perlindungan terhadap integritas perkara.”"
    ],
    interactive: {
      type: "alternate",
      label: "PERTANYAAN INTERAKTIF",
      questions: [
        "“Apakah di satuan kerja kita sudah ada SOP yang jelas untuk menyita HP, laptop, DVR CCTV, server, atau akun digital?”"
      ],
      guidance: {
        label: "LANJUTKAN:",
        text: ["“Kalau belum, ini harus menjadi perhatian. Karena barang bukti digital tidak bisa diperlakukan sama seperti barang bukti fisik biasa.”"]
      }
    },
    supplements: {
      transition: "“Setelah membahas dua kasus utama—ransomware dan integritas bukti digital—kita masuk ke solusi strategis yang perlu didorong pimpinan.”"
    }
  },
  {
    id: "slide-13",
